        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>AI Pipeline Monitoring</CardTitle>
                <CardDescription>Real-time monitoring of AI services and performance</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full" id="ai-pipeline-btn">
              <Link href="/admin/ai">View Dashboard</Link>
            </Button>
          </CardContent>
        </Card>
