// Service for dynamic structure adaptation with methodology-specific sections
...
/**
 * Service for dynamically adapting thesis structure based on methodology and university requirements
 */
export class DynamicStructureAdapterService {
  /**
  ...
  private static generateRequiredSectionsContent(sections: string[], methodologyType: string): string {
    const sectionDescriptions: Record<string, Record<string, string>> = {
      ...
      "ethnographic": {
        ...
        "Reflexivity": "Maintain detailed reflexive journal documenting personal reactions and biases. Seek peer debriefing and external auditing."
      },
      "action-research": {
  ...
  private static generateOptionalSectionsContent(sections: string[], methodologyType: string): string {
    const sectionDescriptions: Record<string, Record<string, string>> = {
      ...
      "experimental": {
        ...
        "Power Analysis": "Conduct a priori power analysis to justify sample size. If increasing sample size is not feasible, consider alternative designs or analytical approaches. Report achieved power in results."
      },
      "survey": {
  ...
  /**
   * Adapt outline structure based on selected methodology
  ...
  private static generateMethodologyAlignment(methodology: ResearchMethodology): string {
    const alignmentMessages: Record<string, string> = {
      ...
      "case-study": "Your outline has been adapted to align with case study methodology requirements. This includes emphasizing case selection criteria, multiple data sources, and analytical frameworks. The structure focuses on providing in-depth analysis of specific situations or entities within their real-world context.",
      ...
      "action-research": "Your outline has been adapted to align with action research methodology requirements. This includes emphasizing collaborative partnerships, iterative cycles, and practical outcomes. The structure focuses on solving real-world problems through collaborative inquiry and immediate application of findings."
    };
