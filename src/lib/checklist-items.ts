...
export const thesisChecklist: ChecklistPhase[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        toolName: "Research Problem Identifier",
      },
      {
        id: "item-1-2-2",
        title: "Identify Research Gaps",
        description: "Analyze existing literature to identify areas that need further investigation.",
        href: "/research-gap",
        toolName: "Research Gap Identifier",
      },
      {
        id: "item-1-3",
      ...
      {
        id: "item-1-5",
        title: "Analyze Research Articles",
        description: "Deeply analyze academic articles to extract key information and insights.",
        href: "/research-article-analyzer",
        toolName: "Research Article Analyzer",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Generate flashcards to reinforce key concepts and findings.",
        href: "/flashcards",
        toolName: "Flashcards Generator",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        toolName: "University Format Checker",
      },
      {
        id: "item-4-2",
      ...
      },
      {
        ...
        description: "Create an effective presentation to share your research findings.",
        href: "/presentation",
        toolName: "Presentation Tool",
      },
      {
        id: "item-4-7",
        title: "Practice for Your Defense",
        description: "Prepare for your thesis defense with simulated Q&A sessions.",
        href: "/qa-simulator",
        toolName: "Q&A Simulator",
      },
    ],
  },
];