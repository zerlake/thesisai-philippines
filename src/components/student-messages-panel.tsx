            ...
            messages.map((msg) => (
              ...
              >
                ...
                <div className="text-xs text-gray-400 mt-2">
                  From: {msg.sender_role === 'advisor' ? 'Advisor' : msg.sender_role === 'critic' ? 'Critic' : 'Student'}
                </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                From: {selectedMessage.sender_role === 'advisor' ? 'Advisor' : selectedMessage.sender_role === 'critic' ? 'Critic' : 'Student'}
              </p>
