...
export function NovelEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'prose dark:prose-invert max-w-none focus:outline-none min-h-[600px] w-full p-8 bg-white dark:bg-slate-950 text-gray-900 dark:text-gray-100 rounded-lg border relative', // Added 'relative' for autocomplete overlay positioning
      },
    },
    onUpdate: ({ editor }) => {
...
- Maintains academic tone`;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg bg-white dark:bg-slate-950 overflow-hidden relative">
