...
import { ArrowRight, ArrowUp, ArrowDown, ArrowLeft, MessageSquare, FileText, TrendingUp, Users } from "lucide-react";
...
import { AdvisorCommunicationHub } from "./communication-hub";
import { DocumentReviewTools } from "./document-review-tools";
...
export function AdvisorDashboardFull() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'communication' | 'documents' | 'analytics' | 'management'>('overview');
  ...
  return (
    <div className="space-y-8">
      ...
      {activeView === 'communication' && <AdvisorCommunicationHub />}
      {activeView === 'documents' && <DocumentReviewTools />}
