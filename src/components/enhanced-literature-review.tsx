...
export function EnhancedLiteratureReview() {
  ...
  // State for Research Gap Analysis
  ...
  const handleCheck = async (checkType: "web" | "internal" | "gaps") => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Enhanced Literature Review Helper
          </CardTitle>
          <CardDescription>
            Search for sources, identify research gaps, and generate synthesized reviews with comprehensive analysis.
          </CardDescription>
        </CardHeader>
