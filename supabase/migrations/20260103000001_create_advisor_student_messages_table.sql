...
-- Index for performance (drop existing first if needed)
DROP INDEX IF EXISTS idx_advisor_student_messages_document;
DROP INDEX IF EXISTS idx_advisor_student_messages_sender;
DROP INDEX IF EXISTS idx_advisor_student_messages_recipient;
DROP INDEX IF EXISTS idx_advisor_student_messages_created;
