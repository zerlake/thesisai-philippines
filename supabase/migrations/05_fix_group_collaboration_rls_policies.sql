...
-- This migration fixes the recursive RLS policies in the group collaboration tables

-- Drop existing policies that cause recursion
DROP POLICY IF EXISTS "Users can view their own research groups" ON research_groups;
DROP POLICY IF EXISTS "Group leaders and co-leaders can insert group" ON research_groups;
DROP POLICY IF EXISTS "Group leaders and co-leaders can update group" ON research_groups;
DROP POLICY IF EXISTS "Group leaders and co-leaders can delete group" ON research_groups;

DROP POLICY IF EXISTS "Members can view group memberships" ON group_memberships;
DROP POLICY IF EXISTS "Group leaders and co-leaders can manage memberships" ON group_memberships;
...
-- Create new non-recursive policies for research_groups
...
-- Create new non-recursive policies for group_memberships
...
-- Create new non-recursive policies for group_invitations
...
-- Create new non-recursive policies for group_communications
...
-- Create new non-recursive policies for group_tasks
...
-- Create new non-recursive policies for group_documents
