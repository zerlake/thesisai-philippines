-- Create comprehensive rate limiting tables for ThesisAI
-- This migration implements plan-based quotas, auth protection, and metrics tracking
...
CREATE TABLE IF NOT EXISTS public.auth_failure_tracking (
  ...
  identifier_value TEXT NOT NULL,
  additional_identifier TEXT, -- For ip_email_pair, stores the other identifier
...
-- =====================================================================
-- 8. Cleanup Job (PostgreSQL job scheduling or call from app)
-- =====================================================================
