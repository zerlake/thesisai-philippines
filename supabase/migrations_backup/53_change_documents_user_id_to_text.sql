-- Change user_id column from UUID to TEXT to support demo users
-- This allows demo mode to work without proper authentication

-- Create a new documents table with TEXT user_id
