...
async function generateQuestionsWithGemini(textContent: string, apiKey: string) {
  const prompt = `
    ...
    - The interpretation of the key findings.
    - The implications and recommendations of the research.
    - Potential alternative explanations or future research directions.
