...
// Security utilities - prevent SSRF, injection attacks
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const searchUrl = `https://serpapi.com/search.json?engine=google&q=${encodeURIComponent(sanitizedQuery)}&api_key=${serpApiKey}`;
